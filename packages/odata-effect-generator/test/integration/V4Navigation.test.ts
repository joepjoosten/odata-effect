...
describe("V4 Navigation Generation", () => {
  it("generates tree-shakable PathBuilders", () =>
    Effect.gen(function*() {
      ...
      expect(content).toContain("export const fetchCollection = <T, I>(schema: Schema.Codec<T, I>)")
      expect(content).toContain("export const fetchOne = <T, I>(schema: Schema.Codec<T, I>)")

...
- [#72](https://github.com/joepjoosten/odata-effect/pull/72) [`c8710e4`](https://github.com/joepjoosten/odata-effect/commit/c8710e40f2930dabbb36b60d9b6b1b46ddccf561) Thanks [@joepjoosten](https://github.com/joepjoosten)! - Generate distinct CreateEntity and editable/update schemas. Include client-assigned keys on creation, honor inline Core.Computed/Core.Immutable and SAP creatable/updatable metadata, and allow CRUD factories to accept an optional createSchema while preserving the legacy default.

- [#66](https://github.com/joepjoosten/odata-effect/pull/66) [`b2e7251`](https://github.com/joepjoosten/odata-effect/commit/b2e725118d6c25f4c45bd12a9ec16e22b10029aa) Thanks [@joepjoosten](https://github.com/joepjoosten)! - Emit removable schema, service and query-path initializers in files-only output. Add independently exported CRUD operations for operation-level tree shaking while preserving service objects.

- [#71](https://github.com/joepjoosten/odata-effect/pull/71) [`6fd021b`](https://github.com/joepjoosten/odata-effect/commit/6fd021bf8d304bf327c079fed2b1f4a8979926a4) Thanks [@joepjoosten](https://github.com/joepjoosten)! - Add getAllWithSchema/getByIdWithSchema and generated standalone WithSchema reads for typed projections. Implicit full-entity reads reject root/nested $select options before HTTP rather than decoding a projection as a full entity.

- [#73](https://github.com/joepjoosten/odata-effect/pull/73) [`e90ef7b`](https://github.com/joepjoosten/odata-effect/commit/e90ef7b01e09aabaade8f4179bf0a5190005c549) Thanks [@joepjoosten](https://github.com/joepjoosten)! - Generate self-contained ESM packages with local TypeScript configs and Node test scripts, explicit build dependencies, compatible Effect versions and publishable exports. Default package-mode imports to .js extensions and remove repository-specific workspace paths.

### Patch Changes

- [#70](https://github.com/joepjoosten/odata-effect/pull/70) [`e3730b7`](https://github.com/joepjoosten/odata-effect/commit/e3730b7479d506e44b62f79bfb85f1ce32bd9378) Thanks [@joepjoosten](https://github.com/joepjoosten)! - Share entity-key serialization across V2, V4 and generated byKey paths. Escape apostrophes and percent-encode URL delimiters in scalar and composite string keys.

- [#63](https://github.com/joepjoosten/odata-effect/pull/63) [`7f9b4be`](https://github.com/joepjoosten/odata-effect/commit/7f9b4beb4a3dd2e0f93fd416842eb808bdcc572f) Thanks [@joepjoosten](https://github.com/joepjoosten)! - Generate enum schemas using Effect 4 Schema.Literals so every declared member is accepted.

- [#75](https://github.com/joepjoosten/odata-effect/pull/75) [`e704d61`](https://github.com/joepjoosten/odata-effect/commit/e704d61190453ff0dec7d90397b684a1de4554ac) Thanks [@joepjoosten](https://github.com/joepjoosten)! - Infer the generated byKey entity type from its collection path, allowing keyed paths to compose with typed navigation and fetch operations without becoming Path<unknown>.

- [#65](https://github.com/joepjoosten/odata-effect/pull/65) [`a58e68a`](https://github.com/joepjoosten/odata-effect/commit/a58e68a9c7037f7da1d33d4c835b579e56dab36d) Thanks [@joepjoosten](https://github.com/joepjoosten)! - Resolve inherited fields, navigation properties and primary keys before generating models, services and query paths. Reject missing/cyclic bases and preserve renamed type references.

- [#67](https://github.com/joepjoosten/odata-effect/pull/67) [`4029df2`](https://github.com/joepjoosten/odata-effect/commit/4029df2174ae746104f6bef5ed4f35074cea0a75) Thanks [@joepjoosten](https://github.com/joepjoosten)! - Carry protocol and EDM type metadata in generated query paths. Serialize V2 substringof, V4 dates/timestamps/durations, GUIDs and numeric literals correctly, preserve metadata through scalar transforms/lambdas, and reject unsupported lambda/nested-expand queries in V2.

- [#64](https://github.com/joepjoosten/odata-effect/pull/64) [`8007fbe`](https://github.com/joepjoosten/odata-effect/commit/8007fbe304d841c6269d57bc1501f579adeb15ac) Thanks [@joepjoosten](https://github.com/joepjoosten)! - Use the unified ODataClientConfig service in generated V4 operations and their context types.

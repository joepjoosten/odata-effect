 ...
 */
export const getPromiseServiceName = (entitySetName: string): string =>
  `${getServiceClassName(entitySetName)}Promise`
...
export const generatePromiseServiceFns = (dataModel: DataModel): PromiseServiceGenerationResult => {
  const entityServices: GeneratedPromiseServiceFile[] = []
